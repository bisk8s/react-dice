...
import { V10Materials } from '../../utils/Material';
...
export default function D10({ position, name, check }) {
  ...
  const [ref] = useConvexPolyhedron(() => {
    return {
      ...
      onCollide: () => {
        const diceValue = getDiceValue('V10', geometry, ref.current);
        let dices = {};
        dices[name || 'v10'] = {
          V10: ['Fail', 'Success', 'Critical'][diceValue],
        };
  ...
  return <mesh ref={ref} geometry={geometry} material={V10Materials} />;
}
